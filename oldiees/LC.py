...
vctr_velocity_Rogue_L[0] = np.array([0, 0, -20])
...
def Plot3D():
    ...
    file_name = "Dataset_LC_31.01.png"
...
def AxVid():
        ...
        if len(p_earth_x) >0:
            ...
            ani.save('Dataset_LC_31.01.gif', writer='qt', fps=10)
AxVid()
